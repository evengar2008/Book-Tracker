 ...
 */
function orbisius_ctc_twentyseventeen_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ctc_twentyseventeen_parent_style';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ctc_twentyseventeen_child_theme_enqueue_styles' );
